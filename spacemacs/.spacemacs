...
values."
  (setq-default
   ...
   '(sql
     ...
     (org :variables org-projectile-file "/home/arne/org/ProjectTODOs.org")
     ;; spell-checking
     syntax-checking
     ;; version-control
     )
...
(with-eval-after-load 'org-agenda
  ...
  (setq org-agenda-files (list "~/org/notes.org" "~/org/pers.org" "~/org/school.org" "~/org/zeus.org"))
  (mapcar '(lambda (file)
